...
if __name__ == "__main__":
    ...
    sub_dir = "test/polygon/"

    full_dataset_path = os.path.join(base_dir, f'{sub_dir}full-dataset')

    create_subset_with_labels(full_dataset_path, os.path.join(base_dir, f'{sub_dir}sub-dataset/n_10/truth'), 10, 10)
    create_subset_with_labels(full_dataset_path, os.path.join(base_dir, f'{sub_dir}sub-dataset/n_20/truth'), 20, 5)